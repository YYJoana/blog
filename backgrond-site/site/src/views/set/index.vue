<template>
  <div class="app-container">
    ...
    <div class="block1">网站图标信息</div>
    <div class="block2">网站图标地址</div>
    <div style="margin-bottom: 15px; width: 500px">
      <el-input v-model="form.favicon" disabled placeholder="请输入图片地址">
      </el-input>
    </div>

    <div class="block2">网站图标预览</div>
...
<script>
import { modyfySeting, getSeting } from "@/api/set.js";
